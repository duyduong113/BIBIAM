...
namespace ERP_API.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        ////[AllowAnonymous]
        //[HttpGet]
        //public string Activation(string key, string email, string username, string ten_gian_hang)
        //{
        //    using (SqlConnection conn = new SqlConnection(BIBIAM.Core.Data.AllConstant.MCCConnectionString))
        //    {
