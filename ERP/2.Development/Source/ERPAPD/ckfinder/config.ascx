...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        //BaseUrl = "../../../../upload";
        BaseUrl = Page.ResolveUrl("~/Content/image/upload/");
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "jpeg", "jpg", "png", "pdf", "doc", "docx" };
        type.DeniedExtensions = new string[] { "bmp", "gif" };
        ...
        //type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "swf", "flv", "mov", "mp4" };
        type.DeniedExtensions = new string[] { };
    }
