...
namespace ERPAPD.Models
{
    public class CRM_Ticket_Type
    {
        ...
        public CRM_Ticket_Type(){ }


        public int Save()
        {
            string PROCEDURE = "p_SaveCRM_Ticket_Type";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateCRM_Ticket_Type";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteCRM_Ticket_Type";
        ...
        public static CRM_Ticket_Type GetCRM_Ticket_Type(string TypeID)
        {
            string PROCEDURE = "p_SelectCRM_Ticket_Type";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@TypeID";
            parameters[0].Value = TypeID;
        ...
        public static List<CRM_Ticket_Type> GetAllCRM_Ticket_Types()
        {
            string PROCEDURE = "p_SelectCRM_Ticket_TypesAll";
        ...
        public static List<DropListDown> GetAllCRM_Ticket_Types_Active()
        {
            string PROCEDURE = "p_SelectCRM_Ticket_TypesAll";
        ...
        public static List<CRM_Ticket_Type> GetListUserInType(string TypeID)
        {
            string PROCEDURE = "p_SelectCRM_Ticket_Type_User";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@TypeID";
            parameters[0].Value = TypeID;
        ...
        {
            string PROCEDURE = "p_SelectCRM_Ticket_TypesAll_Category";
            SqlParameter[] parameters = new SqlParameter[1];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@categoryid";
        ...
        {
            string PROCEDURE = "delete CRM_Ticket_Type_Queue where @TypeID= TypeID";
            SqlParameter[] parameters = new SqlParameter[1];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@TypeID";
