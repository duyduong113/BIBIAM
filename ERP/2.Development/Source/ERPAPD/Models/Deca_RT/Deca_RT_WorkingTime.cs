...
{
    /// <summary>
    /// This object represents the properties and methods of a Deca_RT_WorkingTime.
    /// </summary>
    public class Deca_RT_WorkingTime
    {
        #region Members
        ...
        public Deca_RT_WorkingTime()
        { }


        public int Save()
        {
            string PROCEDURE = "p_SaveDeca_RT_WorkingTime";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateDeca_RT_WorkingTime";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteDeca_RT_WorkingTime";
        ...
        public static Deca_RT_WorkingTime GetDeca_RT_WorkingTime(string WorkingTimeID)
        {
            string PROCEDURE = "p_SelectDeca_RT_WorkingTime";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@WorkingTimeID";
            parameters[0].Value = WorkingTimeID;
            ...
            return dt.AsEnumerable().Select(row => new Deca_RT_WorkingTime
            {
        ...
        //public static List<Deca_RT_WorkingTime> GetDeca_RT_WorkingTimes(string whereCondition, string orderByExpression)
        //{
        //    string PROCEDURE = "p_SelectDeca_RT_WorkingTimesDynamic";
        ...
        public static List<Deca_RT_WorkingTime> GetAllDeca_RT_WorkingTimes()
        {
            string PROCEDURE = "p_SelectDeca_RT_WorkingTimesAll";
        ...
        public static Deca_RT_WorkingTime GetDeca_RT_WorkingTime_ByUserName(string UserName)
        {
            string PROCEDURE = "p_SelectDeca_RT_WorkingTime_ByUserID";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
        ...
        //{
        //    string PROCEDURE = "p_SelectDeca_RT_WorkingTime_Getdepartment";
        //    SqlParameter[] parameters = new SqlParameter[1];
        //    parameters[0] = new SqlParameter();
        //    parameters[0].ParameterName = "@WorkingTimeID";
        //    parameters[0].Value = workingtimeid;
