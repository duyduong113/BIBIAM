...
{
    /// <summary>
    /// This object represents the properties and methods of a Deca_RT.
    /// </summary>
    public class Deca_RT_Ticket
    {
        #region Members
        ...
        public List<Deca_RT_Follower> Follower { get; set; }
        #endregion

        public Deca_RT_Ticket()
        { }
        private void genetime()
        {
            var work = Deca_RT_WorkingTime.GetDeca_RT_WorkingTime_ByUserName(this.Owner);
            var holiday = Deca_RT_Holiday.GetDeca_RT_Holiday_ByDate(this.RowCreatedTime);
        ...
        private DateTime addtime(Deca_RT_WorkingTime work, List<Deca_RT_Holiday> holiday, int time)
        {
        ...
        public string Save()
        {
            var type = Deca_RT_Type.GetDeca_RT_Type(this.TypeID);
            if (type == null)
            {
                return "";
            }
            ...
            this.ResolveTime = 0;
            this.ClosedTime = 0;
            var kpi = Deca_RT_KPI.GetDeca_RT_KPI(TypeID, Priority, Impact);
            if (kpi != null)
            {
            ...
            genetime();
            string PROCEDURE = "p_SaveDeca_RT_Ticket";
        ...
        public int Update(int x)
        {
            ...
            string PROCEDURE = "p_UpdateDeca_RT_Ticket";
            ...
            //var datacredit = Deca_RequestCredit.GetDeca_RequestCreditByTicketID(this.TicketID);
            //if (datacredit != null)
            //{
        ...
        public int UpdateCreateTime()
        {
            ...
            string PROCEDURE = "p_UpdateDeca_RT_Ticket_CreateTime";
        ...
        public int UpdateNew()
        {
            ...
            string PROCEDURE = "update Deca_RT_Ticket set isnew = 1 where TicketID = @TicketID";
        ...
        public int UpdateTicketByStatus()
        {
            ...
            string PROCEDURE = "p_UpdateDeca_RT_TicketByStatus";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteDeca_RT_Ticket";
            SqlParameter[] parameters = new SqlParameter[1];
        ...
        public static Deca_RT_Ticket GetDeca_RT_Ticket(string TicketID)
        {
            string PROCEDURE = "p_SelectDeca_RT_Ticket";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@TicketID";
            parameters[0].Value = TicketID;
            ...
            return dt.AsEnumerable().Select(row => new Deca_RT_Ticket
            {
        ...
        public static List<Deca_RT_Ticket> GetAllDeca_RT_Tickets(string UserName)
        {
            string PROCEDURE = "p_SelectDeca_RT_TicketsAll";
            SqlParameter[] parameters = new SqlParameter[1];
            int i = 0;
            parameters[i] = new SqlParameter();
            ...
            i++;
            DataTable dt = SqlHelperAsync.ExecuteDataTable(Constants.AllConstants().CONNECTION_STRING, System.Data.CommandType.StoredProcedure, PROCEDURE, parameters);
            return dt.AsEnumerable().Where(s => s["TicketID"].ToString() != "").Select(row => new Deca_RT_Ticket
            {
                TicketID = row["TicketID"].ToString(),
                Status = row["Status"].ToString(),
                TypeID = row["TypeID"].ToString(),
        ...
        public static List<Deca_RT_Ticket> GetAllDeca_RT_Tickets_ViewAll(string UserName)
        {
            string PROCEDURE = "p_SelectDeca_RT_TicketsAll_ViewAll";
            SqlParameter[] parameters = new SqlParameter[1];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@UserID";
            ...
            return dt.AsEnumerable().Where(s => s["TicketID"].ToString() != "").Select(row => new Deca_RT_Ticket
            {
                ...
                RegionalOPS = row["RegionalOPS"].ToString(),
                MOPRegion = row["MOPRegion"].ToString(),
                Follower = Deca_RT_Follower.GetAllDeca_RT_Followers(row["TicketID"].ToString())
            }).ToList();
        }
        public static DataSourceResult GetAllDeca_RT_Tickets_Dynamic(string UserName, string where, [DataSourceRequest] DataSourceRequest request)
        {
            string PROCEDURE = "p_SelectDeca_RT_TicketsAll_Dynamic";
            ...
            data.Data = dt.AsEnumerable().Where(s => s["TicketID"].ToString() != "").Select(row => new Deca_RT_Ticket
            {
                TicketID = row["TicketID"].ToString(),
                Status = row["Status"].ToString(),
                TypeID = row["TypeID"].ToString(),
        ...
        public static DataSourceResult GetAllDeca_RT_Tickets_ViewAll_Dynamic(string UserName, string where, [DataSourceRequest] DataSourceRequest request)
        {
            string PROCEDURE = "p_SelectDeca_RT_TicketsAll_ViewAll_Dynamic";
            var from1 = (request.Page - 1) * request.PageSize + 1;
            var to = (request.Page - 1) * request.PageSize + request.PageSize;
        ...
        public static List<Deca_RT_Ticket> GetDeca_RT_Tickets_Suggets_ViewAll(string UserName, string where)
        {
            string PROCEDURE = "p_SelectDeca_RT_Tickets_Suggets_ViewAll";
            SqlParameter[] parameters = new SqlParameter[3];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@WhereCondition";
            ...
            data = dt.AsEnumerable().Where(s => s["TicketID"].ToString() != "").Select(row => new Deca_RT_Ticket
            {
                TicketID = row["TicketID"].ToString(),
                Title = row["Title"].ToString(),
                Detail = row["Detail"].ToString(),
        ...
        public static List<Deca_RT_Ticket> GetAllDeca_RT_Tickets_ViewAll_Dynamic_API(string fromDate, string toDate)
        {
            string PROCEDURE = "p_SelectDeca_RT_TicketsAll_ViewAll_Dynamic";
        ...
        public static List<Deca_RT_Ticket> GetAllDeca_RT_Tickets_Customer(string CustomerID)
        {
            string PROCEDURE = "p_SelectDeca_RT_TicketsAll_Customer";
            SqlParameter[] parameters = new SqlParameter[1];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@CustomerID";
        ...
        public static Deca_RT_Ticket GetDeca_RT_Ticket_checkcanview(string TicketID, string UserName, string Department, string Team)
        {
            string PROCEDURE = "p_SelectDeca_RT_Ticket_checkuser";
            SqlParameter[] parameters = new SqlParameter[4];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@TicketID";
        ...
        public static Deca_RT_Ticket GetDeca_RT_Ticket_checkintype(string TypeID, string UserName)
        {
            string PROCEDURE = "p_SelectDeca_RT_Ticket_CheckUserInType";
            SqlParameter[] parameters = new SqlParameter[2];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@TypeID";
        ...
        //{
        //    string PROCEDURE = "p_Deca_RT_SendRemindToType";
        //    SqlParameter[] parameters = new SqlParameter[1];
        //    int i = 0;
        //    parameters[i] = new SqlParameter();
        //    parameters[i].ParameterName = "@TypeID";
        ...
        {
            string PROCEDURE = "select count(ticketid)  from Deca_RT_Ticket where isnew = 1 and  Status NOT in ('Closed', 'Cancelled', 'Resolved') and Assignee = '" + UserName.Replace("'", "''") + "'";
        ...
        {
            string PROCEDURE = "select count(ticketid)  from Deca_RT_Ticket where isnew = 1 and  Status NOT in ('Closed', 'Cancelled', 'Resolved') and preAssignee = '" + UserName.Replace("'", "''") + "'  ";
        ...
        {
            string PROCEDURE = "select count(ticketid)  from Deca_RT_Ticket where isnew = 1 and  Status NOT in ('Closed', 'Cancelled', 'Resolved') and Requestor = '" + UserName.Replace("'", "''") + "'  ";
        ...
        {
            string PROCEDURE = "select count(ticketid)  from Deca_RT_Ticket where isnew = 1 and  Status =  'Resolved' and Requestor = '" + UserName.Replace("'", "''") + "'  ";
        ...
        public static string CountQueueTicket(string UserName)
        {
            ...
            string PROCEDURE = "p_SelectDeca_RT_Ticket_CountQueueTicket";
            SqlParameter[] parameters = new SqlParameter[1];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@UserID";
        ...
        public int UpdateIsDoneForTeleSale()
        {
            ...
            string PROCEDURE = "p_UpdateDeca_RT_Ticket_IsDoneForTeleSale";
            SqlParameter[] parameters = new SqlParameter[2];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@TicketID";
