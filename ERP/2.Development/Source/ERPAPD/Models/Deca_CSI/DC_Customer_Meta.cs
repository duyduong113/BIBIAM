...
namespace ERPAPD.Models
{
    public class DC_Customer_Meta
    {
        ...
        public DC_Customer_Meta()
        { }

        public DC_Customer_Meta(string CustomerID, string Factor, string Value, bool Active, int RowID, DateTime RowCreatedTime, string RowCreatedUser, DateTime RowLastUpdatedTime, string RowLastUpdatedUser)
        {
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveDC_Customer_Meta";
            ...
            Helpers.RemoveCache.CacheCustomer();
            return result;
        }

        public int Update()
        {
            string PROCEDURE = "p_UpdateDC_Customer_Meta";
            SqlParameter[] parameters = new SqlParameter[6];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@CustomerID";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteDC_Customer_Meta";
        ...
        public static DC_Customer_Meta GetDC_Customer_Meta(string CustomerID, string Factor)
        {
            string PROCEDURE = "p_SelectDC_Customer_Meta";
            SqlParameter[] parameters = new SqlParameter[2];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@CustomerID";
            ...
            return dt.AsEnumerable().Select(row => new DC_Customer_Meta
            {
        ...
        public static List<DC_Customer_Meta> GetDC_Customer_Metas(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectDC_Customer_MetasDynamic";
            SqlParameter[] parameters = new SqlParameter[2];
            int i = 0;
            parameters[i] = new SqlParameter();
        ...
        public static List<DC_Customer_Meta> GetAllDC_Customer_Metas()
        {
            string PROCEDURE = "p_SelectDC_Customer_MetasAll";
