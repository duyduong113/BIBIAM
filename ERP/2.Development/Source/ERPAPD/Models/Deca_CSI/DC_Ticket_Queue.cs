...
{
    /// <summary>
    /// This object represents the properties and methods of a DC_Ticket_Queue.
    /// </summary>
    public class DC_Ticket_Queue
    {
        #region Members
        ...
        public DC_Ticket_Queue()
        { }


        public int Save()
        {
            string PROCEDURE = "p_SaveDC_Ticket_Queue";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateDC_Ticket_Queue";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteDC_Ticket_Queue";
        ...
        public static DC_Ticket_Queue GetDC_Ticket_Queue(string QueueID)
        {
            string PROCEDURE = "p_SelectDC_Ticket_Queue";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@QueueID";
            parameters[0].Value = QueueID;
            ...
            return dt.AsEnumerable().Select(row => new DC_Ticket_Queue
            {
        ...
        //public static List<DC_Ticket_Queue> GetDC_Ticket_Queues(string whereCondition, string orderByExpression)
        //{
        //    string PROCEDURE = "p_SelectDC_Ticket_QueuesDynamic";
        ...
        public static List<DC_Ticket_Queue> GetAllDC_Ticket_Queues()
        {
            string PROCEDURE = "p_SelectDC_Ticket_QueuesAll";
        ...
        public static List<DC_Ticket_Queue> GetListUserInQueue(string QueueID)
        {
            string PROCEDURE = "p_SelectDC_Ticket_Queue_User";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@QueueID";
            parameters[0].Value = QueueID;
        ...
        public static bool CheckUserInQueue(string UserID, string QueueID)
        {
            if (UserID != "" && QueueID != "")
            {
                string PROCEDURE = "p_SelectDC_Ticket_Queue_CheckUserInQueue";
                SqlParameter[] parameters = new SqlParameter[2];
                parameters[0] = new SqlParameter();
