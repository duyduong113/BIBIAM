...
{
    public class DC_Location_Countries
    {
        #region Members
        ...
        public DC_Location_Countries()
        {}

        public DC_Location_Countries(string CountryID, string CountryName, string AliasID, bool Active, int RowID, DateTime RowCreatedTime, string RowCreatedUser, DateTime RowLastUpdatedTime, string RowLastUpdatedUser)
		{ 
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveDC_Location_Country";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateDC_Location_Country";
            SqlParameter[] parameters = new SqlParameter[6];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@CountryID";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteDC_Location_Country";
        ...
        public static DC_Location_Countries GetDC_Location_Countrie(string CountryID)
        {
            string PROCEDURE = "p_SelectDC_Location_Countries";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@CountryID";
            parameters[0].Value = CountryID;
            ...
            return dt.AsEnumerable().Select(row => new DC_Location_Countries
            {
        ...
        public static List<DC_Location_Countries> GetDC_Location_Countries(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectDC_Location_CountriesDynamic";
        ...
        public static List<DC_Location_Countries> GetAllDC_Location_Countries()
        {
            string PROCEDURE = "p_SelectDC_Location_CountriesAll";
        ...
        public static List<DC_Location_Countries> GetList_Countries()
        {
            string PROCEDURE = "select distinct CountryID,CountryName from DC_Location_Countries  where Active = 1";
