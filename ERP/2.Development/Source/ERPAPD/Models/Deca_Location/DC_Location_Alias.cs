...
{
    public class DC_Location_Alias
    {
        #region Members
        ...
        public string AliasName { get{ return _aliasname; } set { this._aliasname = value; } }
        ...
        public DC_Location_Alias()
        {}

        public DC_Location_Alias(string AliasID, string AliasName, bool Active, int RowID, DateTime RowCreatedTime, string RowCreatedUser, DateTime RowLastUpdatedTime, string RowLastUpdatedUser)
		{ 
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveDC_Location_Alias";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateDC_Location_Alias";
            SqlParameter[] parameters = new SqlParameter[5];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@AliasID";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteDC_Location_Alias";
        ...
        public static DC_Location_Alias GetDC_Location_Alia(string AliasID)
        {
            string PROCEDURE = "p_SelectDC_Location_Alias";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@AliasID";
            parameters[0].Value = AliasID;
            ...
            return dt.AsEnumerable().Select(row => new DC_Location_Alias
            {
        ...
        public static List<DC_Location_Alias> GetDC_Location_Alias(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectDC_Location_AliasDynamic";
        ...
        public static List<DC_Location_Alias> GetAllDC_Location_Alias()
        {
            string PROCEDURE = "p_SelectDC_Location_AliasAll";
        ...
        public static List<DC_Location_Alias> GetList_Alias()
        {
            string PROCEDURE = "select distinct AliasID,AliasName from DC_Location_Alias  where Active = 1";
