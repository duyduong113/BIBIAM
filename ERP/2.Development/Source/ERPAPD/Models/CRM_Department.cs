...
namespace ERPAPD.Models
{
    public class CRM_Department
    {
        ...
        public CRM_Department(int DepartmentID, string Department, bool Active, DateTime CreatedDatetime, string CreatedUser, DateTime LastUpdatedDateTime, string LastUpdatedUser)
		{ 
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveCRM_Department";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateCRM_Department";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteCRM_Department";
        ...
        public static CRM_Department GetCRM_Department(int DepartmentID)
        {
            string PROCEDURE = "p_SelectCRM_Department";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@DepartmentID";
            parameters[0].Value = DepartmentID;
        ...
        public static List<CRM_Department> GetCRM_Departments(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectCRM_DepartmentsDynamic";
        ...
        public static List<CRM_Department> GetCRM_Departments_TrackingOrder()
        {
            string PROCEDURE = "select  distinct ISNULL (d.DepartmentID, '') As 'DepartmentID', ISNULL (d.Department, '') As 'Department' from Deca_Tracking_Order_ReasonMail r left join CRM_Department d on r.Department = d.DepartmentID";
        ...
        public static List<CRM_Department> GetList()
        {
            string PROCEDURE = "select  DepartmentID, Department from CRM_Department where active =1  order by Department";
