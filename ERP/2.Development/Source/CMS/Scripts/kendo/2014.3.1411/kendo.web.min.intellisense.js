...
intellisense.annotate(kendo.ui, {
    PivCMSonfigurator: function() {
        /// <signature>
        /// <summary>Constructor of kendo.ui.PivCMSonfigurator</summary>
        /// </signature>
    }
});

kendo.ui.PivCMSonfigurator = (function() {
var original = kendo.ui.PivCMSonfigurator;
var wrapper = function() {
var instance = new original();
intellisense.annotate(instance, {
    destroy: function() {
...
jQuery.fn.kendoPivCMSonfigurator = function() {
    this.data("kendoPivCMSonfigurator", new kendo.ui.PivCMSonfigurator());

    return this;
};

intellisense.annotate(jQuery.fn, {
    getKendoPivCMSonfigurator: function() {
        /// <signature>
        /// <summary>
        /// Returns a reference to the kendo.ui.PivCMSonfigurator widget, instantiated on the selector.
        /// </summary>
        /// <returns type="kendo.ui.PivCMSonfigurator">The kendo.ui.PivCMSonfigurator instance (if present).</returns>
        /// </signature>
    },
    kendoPivCMSonfigurator: function(options) {
        /// <signature>
        /// <summary>
        /// Instantiates a kendo.ui.PivCMSonfigurator widget based the DOM elements that match the selector.
        /// &#10;Accepts an object with the following configuration options:
        /// &#10;
...
/// &#10;instance.If the dataSource option is set to a JavaScript object the widget will initialize a new kendo.data.PivotDataSource instance using that value as data source configuration.If the dataSource option is an existing kendo.data.PivotDataSource instance the widget will use that instance and will not initialize a new one.
        ...
        /// &#10;
        /// &#10;height — Number|String 
        /// &#10;The height of the PivCMSonfigurator. Numeric values are treated as pixels.
        /// &#10;
        /// &#10;messages — Object 
