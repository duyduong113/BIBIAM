...
;(function($, window, document, undefined)
{
    ...
    Plugin.prototype = {
        ...
        dragStart: function(e)
        {
            ...
            this.sourceRoot = target.closest('.' + this.options.roCMSlass);
        ...
        dragStop: function(e)
        {
            ...
            var parentId = null;
            if(parentItem !== null && !parentItem.is('.' + this.options.roCMSlass))
            ...
            if($.isFunction(this.options.dropCallback)) {
              var details = {
                ...
                destRoot   : el.closest('.' + this.options.roCMSlass),
        ...
        dragMove: function(e)
        {
            ...
            var pointElRoot = this.pointEl.closest('.' + opt.roCMSlass),
