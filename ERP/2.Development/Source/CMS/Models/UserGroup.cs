    ...
    public class UserGroup
    {
        ...
        public List<Int64> listUser
        {
            get
            {
                ...
                {
                    return dbConn.GetFirstColumn<Int64>("SELECT userId FROM UserInGroup where groupId =" + id);
                }
            }
        }
        ...
        public Int64 totalUser
        {
            get
            {
                using (var dbConn = Helpers.OrmliteConnection.openConn())
                {
                    return dbConn.Scalar<int>("SELECT COUNT(id) FROM UserInGroup WHERE groupId =" + id);
                }
            }
        }
