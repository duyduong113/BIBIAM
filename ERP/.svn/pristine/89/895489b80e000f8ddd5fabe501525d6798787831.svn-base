...
{
    public class CRM_Location_Region
    {
        #region Members
        ...
        public CRM_Location_Region()
        { }

        public CRM_Location_Region(string RegionID, string RegionName, bool Active, int RowID, DateTime RowCreatedTime, string RowCreatedUser, DateTime RowLastUpdatedTime, string RowLastUpdatedUser, string CountryID)
        {
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveCRM_Location_Region";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateCRM_Location_Region";
            SqlParameter[] parameters = new SqlParameter[6];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@RegionID";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteCRM_Location_Region";
        ...
        public static CRM_Location_Region GetCRM_Location_Region(string RegionID)
        {
            string PROCEDURE = "p_SelectCRM_Location_Region";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@RegionID";
            parameters[0].Value = RegionID;
            ...
            return dt.AsEnumerable().Select(row => new CRM_Location_Region
            {
        ...
        public static List<CRM_Location_Region> GetCRM_Location_Regions(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectCRM_Location_RegionsDynamic";
        ...
        public static List<CRM_Location_Region> GetAllCRM_Location_Regions()
        {
            string PROCEDURE = "p_SelectCRM_Location_RegionsAll";
        ...
        public static List<CRM_Location_Region> GetList_Regions()
        {
            string PROCEDURE = "select distinct [RegionID],[RegionName] from [CRM_Location_Region] where [Active] = 1";
        ...
        {
            string PROCEDURE = "select distinct RegionID,RegionName from CRM_Location_Region  where Active = 1 and CountryID='" + Country.Replace("'", "''") + "'";
