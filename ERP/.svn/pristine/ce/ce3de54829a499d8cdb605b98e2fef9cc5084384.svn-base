...
{
    public class CRM_Business_Unit_Manager
    {
        #region Members
        ...
        public CRM_Business_Unit_Manager()
        { }

        public CRM_Business_Unit_Manager(string BusinessID, string UserID, bool Active, int RowID, DateTime RowCreatedTime, string RowCreatedUser, DateTime RowLastUpdatedTime, string RowLastUpdatedUser)
        {
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveCRM_Business_Unit_Manager";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateCRM_Business_Unit_Manager";
            SqlParameter[] parameters = new SqlParameter[5];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@BusinessID";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteCRM_Business_Unit_Manager";
        ...
        public static List<CRM_Business_Unit_Manager> GetCRM_Business_Unit_Manager(string BusinessID)
        {
            string PROCEDURE = "p_SelectCRM_Business_Unit_Manager";
            ...
            return dt.AsEnumerable().Select(row => new CRM_Business_Unit_Manager
            {
        ...
        public static List<CRM_Business_Unit_Manager> GetCRM_Business_Unit_Managers(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectCRM_Business_Unit_ManagersDynamic";
            SqlParameter[] parameters = new SqlParameter[2];
            int i = 0;
            parameters[i] = new SqlParameter();
        ...
        public static List<CRM_Business_Unit_Manager> GetAllCRM_Business_Unit_Managers()
        {
            string PROCEDURE = "p_SelectCRM_Business_Unit_ManagersAll";
        ...
        public static List<CRM_Business_Unit_Manager> GetDeca_Business_Unit_User(string BusinessID)
        {
