...
{
    /// <summary>
	/// This object represents the properties and methods of a DC_Step_Definition.
	/// </summary>
	public class DC_Step_Definition
	{
        #region Members
        ...
        public DC_Step_Definition()
        {}
        
        public DC_Step_Definition(string StepID, string Description, string StageID, bool Active, string XMLString, int RowID, DateTime RowCreatedTime, string RowCreatedUser, DateTime RowLastUpdatedTime, string RowLastUpdatedUser)
		{ 
            this._stepid = StepID;  
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveDC_Step_Definition";
            SqlParameter[] parameters = new SqlParameter[6];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@StepID";
            parameters[i].Value =string.IsNullOrEmpty(this._stepid) ? "" : this._stepid;
            i++;
            parameters[i] = new SqlParameter();
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateDC_Step_Definition";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteDC_Step_Definition";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@StepID";
            parameters[0].Value = StepID;
            
            return SqlHelperAsync.ExecuteNonQuery(Constants.AllConstants().CONNECTION_STRING,CommandType.StoredProcedure, PROCEDURE, parameters);
        }
        
        public static DC_Step_Definition GetDC_Step_Definition(string StepID)
        {
            string PROCEDURE = "p_SelectDC_Step_Definition";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@StepID";
            parameters[0].Value = StepID;
            ...
            DataTable dt = SqlHelperAsync.ExecuteDataTable(Constants.AllConstants().CONNECTION_STRING,CommandType.StoredProcedure, PROCEDURE, parameters);
             return dt.AsEnumerable().Select(row => new DC_Step_Definition
            {
        ...
        public static List<DC_Step_Definition> GetDC_Step_Definitions(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectDC_Step_DefinitionsDynamic";
        ...
        public static List<DC_Step_Definition> GetAllDC_Step_Definitions()
        {
            string PROCEDURE = "p_SelectDC_Step_DefinitionsAll";
        ...
        {
            string PROCEDURE = "p_ActiveDC_StepDefinition";
