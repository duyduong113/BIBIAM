...
{
    public class CRM_Location_City
    {
        #region Members
        ...
        public CRM_Location_City()
        { }

        public CRM_Location_City(string CityID, string CityName, string RegionID, bool Active, int RowID, DateTime RowCreatedTime, string RowCreatedUser, DateTime RowLastUpdatedTime, string RowLastUpdatedUser)
        {
            this._cityid = CityID;
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveCRM_Location_City";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateCRM_Location_City";
            SqlParameter[] parameters = new SqlParameter[6];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@CityID";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteCRM_Location_City";
        ...
        public static CRM_Location_City GetCRM_Location_City(string CityID)
        {
            string PROCEDURE = "p_SelectCRM_Location_City";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@CityID";
            parameters[0].Value = CityID;
            ...
            return dt.AsEnumerable().Select(row => new CRM_Location_City
            {
        ...
        public static List<CRM_Location_City> GetCRM_Location_Citys(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectCRM_Location_CitiesDynamic";
        ...
        public static List<CRM_Location_City> GetAllCRM_Location_Citys()
        {
            string PROCEDURE = "p_SelectCRM_Location_CitiesAll";
        ...
        public static List<CRM_Location_City> GetList_City()
        {
            string PROCEDURE = "select distinct [CityID],[CityName] from [CRM_Location_City] where [Active] = 1";
        ...
        {
            string PROCEDURE = "select distinct CityID,CityName from CRM_Location_City  where Active = 1 and RegionID='" + Region.Replace("'", "''") + "'";
