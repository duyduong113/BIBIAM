...
{
    public class CRM_Survey_Management
    {
        [AutoIncrement]
        [PrimaryKey]
    ...
    public class CRM_Survey_Management_Customer
    {
        [AutoIncrement]
        [PrimaryKey]
        public int Id { get; set; }
    ...
    public class CRM_Survey_Management_Question
    {
        [AutoIncrement]
        [PrimaryKey]
        public int Id { get; set; }
    ...
    public class CRM_Survey_Management_User
    {
        [AutoIncrement]
        [PrimaryKey]
        public int Id { get; set; }
    ...
    public class CRM_Survey_Management_Skip
    {
        [AutoIncrement]
        [PrimaryKey]
        public int Id { get; set; }
    ...
    public class CRM_Survey_Management_Proceeded
    {
        [AutoIncrement]
        [PrimaryKey]
        public int Id { get; set; }
    ...
    public class CRM_Survey_Management_Proceeded_Answer
    {
        [AutoIncrement]
        [PrimaryKey]
        public int Id { get; set; }
    ...
    public class CRM_Survey_Category
    {
        [AutoIncrement]
        public int Id { get; set; }
        public string CategoryID { get; set; }
    ...
    public class CRM_Survey_Question
    {
        [AutoIncrement]
        public int Id { get; set; }
        public string CategoryID { get; set; }
        ...
        public static List<CRM_Survey_Question> GetReviewResult(string ManagementID, string OrganizationID, string EmployeeID)
        {
            string PROCEDURE = "CRM_Survey_List_Showing_Review";
            ...
            return dt.AsEnumerable().Select(row => new CRM_Survey_Question
            {
        ...
        public static List<CRM_Survey_Question> GetQuestionByOrg(string ManagementID, string OrganizationID, int QuestionFrequency, string UserSurvey)
        {
            string PROCEDURE = "p_Select_SurveyQuestion";
        ...
        public static List<CRM_Survey_Question> GetQuestionList(string QuestionID)
        {
            string PROCEDURE = "select * from CRM_Survey_AnswerList where QuestionID = '" + QuestionID + "' AND Active = 1";
        ...
        public string AnswerID { get; set; }
        [Ignore]
        public List<CRM_Survey_Question> results { set; get; }
    }
    public class CRM_Survey_AnswerList
    {
        [AutoIncrement]
        public int Id { get; set; }
        public string AnswerID { get; set; }
    ...
    public class CRM_Survey_AnswerConfig
    {
        [AutoIncrement]
        public int Id { get; set; }
    ...
    public class CRM_Survey_ExcelView
    {
