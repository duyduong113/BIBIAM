...
namespace ERPAPD.Models
{
    public class CRM_Ticket_KPI
    {
        ...
        public CRM_Ticket_KPI()
        { }


        public int Save()
        {
            string PROCEDURE = "p_SaveCRM_Ticket_KPI";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateCRM_Ticket_KPI";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteCRM_Ticket_KPI";
        ...
        public static CRM_Ticket_KPI GetCRM_Ticket_KPI(string KPIID)
        {
            string PROCEDURE = "p_SelectCRM_Ticket_KPI";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@KPIID";
            parameters[0].Value = KPIID;
            ...
            return dt.AsEnumerable().Select(row => new CRM_Ticket_KPI
            {
        ...
        public static CRM_Ticket_KPI GetCRM_Ticket_KPI(string TypeID, string Priority, string Impact)
        {
            string PROCEDURE = "p_SelectCRM_Ticket_KPI_ByType";
        ...
        //public static List<CRM_Ticket_KPI> GetCRM_Ticket_KPIs(string whereCondition, string orderByExpression)
        //{
        //    string PROCEDURE = "p_SelectCRM_Ticket_KPIsDynamic";
        ...
        public static List<CRM_Ticket_KPI> GetAllCRM_Ticket_KPIs()
        {
            string PROCEDURE = "p_SelectCRM_Ticket_KPIsAll";
