...
namespace CMS
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //begin metronic style
            // css
            bundles.Add(new StyleBundle("~/Content/assets/global/plugins/globalMandatory").Include(
            ...
            bundles.Add(new StyleBundle("~/Content/assets/global/css/themeGlobal").Include(
                      "~/Content/assets/global/css/components.min.css",
                      "~/Content/assets/global/css/plugins.min.css"));

            bundles.Add(new StyleBundle("~/Content/assets/layouts/layout/css/layoutStyle").Include(
                      "~/Content/assets/layouts/layout/css/layout.min.css",
                      "~/Content/assets/layouts/layout/css/themes/light.min.css",
            ...
            bundles.Add(new ScriptBundle("~/Content/assets/global/plugins/corePlugin").Include(
            ...
            bundles.Add(new ScriptBundle("~/Content/assets/global/plugins/pagePlugin").Include(
                      ...
                      "~/Content/assets/layouts/layout/scripts/custom.js",
                      ...
                      "~/Content/assets/pages/scripts/components-select2.min.js",
            ...
            bundles.Add(new ScriptBundle("~/Content/assets/global/scripts/globalScript").Include(
                      "~/Content/assets/global/scripts/app.min.js",
                //"~/Content/assets/pages/scripts/components-date-time-pickers.min.js",
            ...
            bundles.Add(new ScriptBundle("~/Content/assets/layouts/themeLayout").Include(
