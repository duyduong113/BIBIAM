...
{
    public class CRM_Business_Unit
    {
        #region Members
        ...
        public DateTime RowCreatedTime
        {
            get
            {
                return _rowcreatedtime;
            }
            set
            {
                //TimeZoneInfo timeZoneStandare = TimeZoneInfo.FindSystemTimeZoneById(Constants.TIME_ZONEStandard);
                //TimeZoneInfo timeZoneChange = TimeZoneInfo.FindSystemTimeZoneById(Constants.TIME_ZONE);
                this._rowcreatedtime = value;
            }
        }
        ...
        public DateTime RowLastUpdatedTime
        {
            get
            {
                return _rowlastupdatedtime;
            }
            set
            {
                //TimeZoneInfo timeZoneStandare = TimeZoneInfo.FindSystemTimeZoneById(Constants.TIME_ZONEStandard);
                //TimeZoneInfo timeZoneChange = TimeZoneInfo.FindSystemTimeZoneById(Constants.TIME_ZONE);
                this._rowlastupdatedtime = value;
            }
        }
        ...
        #endregion
        public CRM_Business_Unit()
        { }

        public CRM_Business_Unit(string BusinessID, string Name, string Description, string Phone, string Email, string Fax, bool Active, int RowID, DateTime RowCreatedTime, string RowCreatedUser, DateTime RowLastUpdatedTime, string RowLastUpdatedUser)
        {
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveCRM_Business_Unit";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateCRM_Business_Unit";
            SqlParameter[] parameters = new SqlParameter[10];
            int i = 0;
            parameters[i] = new SqlParameter();
            parameters[i].ParameterName = "@BusinessID";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteCRM_Business_Unit";
        ...
        public static CRM_Business_Unit GetCRM_Business_Unit(string BusinessID)
        {
            string PROCEDURE = "p_SelectCRM_Business_Unit";
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter();
            parameters[0].ParameterName = "@BusinessID";
            parameters[0].Value = BusinessID;
            ...
            return dt.AsEnumerable().Select(row => new CRM_Business_Unit
            {
        ...
        public static List<CRM_Business_Unit> GetCRM_Business_Units(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectCRM_Business_UnitsDynamic";
        ...
        public static List<CRM_Business_Unit> GetAllCRM_Business_Units()
        {
            string PROCEDURE = "p_SelectCRM_Business_UnitsAll";
