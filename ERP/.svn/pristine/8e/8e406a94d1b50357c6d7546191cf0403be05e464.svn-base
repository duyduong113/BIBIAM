...
{
    public class Deca_Business_Unit_Department
    {
        #region Members
        ...
        public Deca_Business_Unit_Department()
        { }

        public Deca_Business_Unit_Department(string BusinessID, string DepartmentID, bool Active, int RowID, DateTime RowCreatedTime, string RowCreatedUser, DateTime RowLastUpdatedTime, string RowLastUpdatedUser)
        {
        ...
        public int Save()
        {
            string PROCEDURE = "p_SaveDeca_Business_Unit_Department";
        ...
        public int Update()
        {
            string PROCEDURE = "p_UpdateDeca_Business_Unit_Department";
        ...
        public int Delete()
        {
            string PROCEDURE = "p_DeleteDeca_Business_Unit_Department";
        ...
        public static List <Deca_Business_Unit_Department> GetDeca_Business_Unit_Department(string BusinessID)
        {
            string PROCEDURE = "p_SelectDeca_Business_Unit_Department";
        ...
        public static List<Deca_Business_Unit_Department> GetDeca_Business_Unit_Departments(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectDeca_Business_Unit_DepartmentsDynamic";
            SqlParameter[] parameters = new SqlParameter[2];
            int i = 0;
            parameters[i] = new SqlParameter();
        ...
        public static List<Deca_Business_Unit_Department> GetDeca_Department(string BusinessID)
        {
