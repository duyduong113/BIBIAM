...
AS
BEGIN			    
	if not exists (select * from OPENQUERY(MYSQL_BIBIAM_DEV,'select ma_don_hang,ma_gian_hang from order_merchant') where ma_don_hang=@ma_don_hang and ma_gian_hang = @ma_gian_hang)
	begin
			--Insert Order Header
