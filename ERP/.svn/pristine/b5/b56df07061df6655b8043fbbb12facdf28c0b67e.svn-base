...
{
    public class CRM_Location_District
    {
        #region Members
        [Required]
        ...
        {
            string PROCEDURE = "select distinct DistrictID,DistrictName from CRM_Location_District  where Active = 1 and RegionID='" + Region.Replace("'", "''") + "'";
        ...
        public static List<CRM_Location_District> GetCRM_Location_Districts(string whereCondition, string orderByExpression)
        {
            string PROCEDURE = "p_SelectCRM_Location_DistrictDynamic";
            ...
            return dt.AsEnumerable().Select(row => new CRM_Location_District
            {
